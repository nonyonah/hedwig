...
const ProposalDocument: React.FC<{ proposal: ProposalData; options: PDFGenerationOptions }> = ({ proposal, options }) => {
...
export async function generatePDF(
  ...
  try {
    const doc = React.createElement(ProposalDocument, { proposal, options });
