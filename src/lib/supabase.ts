// // 'use client'; // Can be removed if no client-specific hooks are used directly here
...
// // Export the client directly for database interactions
// export const supabase = createBrowserClient(
//   supabaseUrl,
//   supabaseAnonKey
// );

// // All Supabase auth-related functions below are removed.
