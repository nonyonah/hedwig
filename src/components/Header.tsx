...
export default function Header(): JSX.Element {
    ...
    return (
        <header className="flex flex-col items-center w-full bg-white shadow-sm">
            {/* Main navigation */}
            <div className="flex w-full max-w-[1280px] h-[72px] items-center justify-between px-[108px]">
            ...
            {showSubNav && (
                <div className="flex w-full max-w-[1280px] h-16 items-center justify-between px-[108px]">
                    <nav className="flex items-center gap-1">
