-- =====================================================
-- Recreate Contracts Tables with Correct Schema
-- =====================================================
-- This migration completely recreates the contracts tables
-- to ensure they have the correct schema
-- =====================================================
...
DROP TABLE IF EXISTS legal_contracts CASCADE;

-- Drop functions
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;
DROP FUNCTION IF EXISTS get_token_address(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS update_contract_amount_paid() CASCADE;
DROP FUNCTION IF EXISTS check_contract_completion() CASCADE;
DROP FUNCTION IF EXISTS generate_milestone_invoices() CASCADE;
DROP FUNCTION IF EXISTS update_invoice_status_on_milestone_payment() CASCADE;
DROP FUNCTION IF EXISTS handle_contract_status_change() CASCADE;
DROP FUNCTION IF EXISTS get_contract_summary(UUID) CASCADE;
DROP FUNCTION IF EXISTS mark_milestone_as_paid(UUID, NUMERIC) CASCADE;
DROP FUNCTION IF EXISTS get_overdue_milestones() CASCADE;
...
CREATE INDEX idx_legal_contracts_client_id ON legal_contracts(client_id);
CREATE INDEX idx_legal_contracts_freelancer_id ON legal_contracts(freelancer_id);
CREATE INDEX idx_legal_contracts_client_email ON legal_contracts(client_email);
CREATE INDEX idx_legal_contracts_freelancer_email ON legal_contracts(freelancer_email);
CREATE INDEX idx_legal_contracts_status ON legal_contracts(status);
CREATE INDEX idx_legal_contracts_chain ON legal_contracts(chain);
CREATE INDEX idx_legal_contracts_created_at ON legal_contracts(created_at);
CREATE INDEX idx_legal_contracts_contract_hash ON legal_contracts(contract_hash);

-- Contracts indexes
CREATE INDEX idx_contracts_client_id ON contracts(client_id);
CREATE INDEX idx_contracts_freelancer_id ON contracts(freelancer_id);
CREATE INDEX idx_contracts_status ON contracts(status);
CREATE INDEX idx_contracts_approval_token ON contracts(approval_token);
...
CREATE INDEX idx_contract_invoices_contract_id ON contract_invoices(contract_id);
CREATE INDEX idx_contract_invoices_milestone_id ON contract_invoices(milestone_id);
CREATE INDEX idx_contract_invoices_status ON contract_invoices(status);
CREATE INDEX idx_contract_invoices_invoice_number ON contract_invoices(invoice_number);
