...
const nextConfig = {
  env: {
    ...
    ALCHEMY_SOLANA_API_KEY: process.env.ALCHEMY_SOLANA_API_KEY,
    ALCHEMY_SOLANA_SIGNING_KEY: process.env.ALCHEMY_SOLANA_SIGNING_KEY,
    ALCHEMY_SOLANA_AUTH_TOKEN: process.env.ALCHEMY_SOLANA_AUTH_TOKEN,
    ALCHEMY_SOLANA_URL: process.env.ALCHEMY_SOLANA_URL,
    // Hedwig Payment Contract Configuration
    HEDWIG_PAYMENT_CONTRACT_ADDRESS: process.env.HEDWIG_PAYMENT_CONTRACT_ADDRESS,
    HEDWIG_PAYMENT_CONTRACT_ADDRESS_TESTNET: process.env.HEDWIG_PAYMENT_CONTRACT_ADDRESS_TESTNET,
    HEDWIG_PAYMENT_CONTRACT_ADDRESS_MAINNET: process.env.HEDWIG_PAYMENT_CONTRACT_ADDRESS_MAINNET,
    BASE_RPC_URL: process.env.BASE_RPC_URL,
    BASE_SEPOLIA_RPC_URL: process.env.BASE_SEPOLIA_RPC_URL,
    BASE_MAINNET_RPC_URL: process.env.BASE_MAINNET_RPC_URL,
    HEDWIG_PLATFORM_WALLET: process.env.HEDWIG_PLATFORM_WALLET,
    HEDWIG_PLATFORM_WALLET_TESTNET: process.env.HEDWIG_PLATFORM_WALLET_TESTNET,
    HEDWIG_PLATFORM_WALLET_MAINNET: process.env.HEDWIG_PLATFORM_WALLET_MAINNET,
    HEDWIG_ADMIN_KEY: process.env.HEDWIG_ADMIN_KEY,
